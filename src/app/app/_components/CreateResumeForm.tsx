...
export const templateFormSchema: Section[] = [
    ...
    },
    {
        ...
        fields: [
            ...
            {
                name: 'degreeType', label: 'Degree Type', type: 'select', options: [
            ...
            { name: 'startDate', label: 'Start Date', type: 'date', gridColSpan: 1 },
            { name: 'endDate', label: 'End Date', type: 'date', gridColSpan: 1 },
            { name: 'courses', label: 'Relevant Courses', type: 'arrayInput', fields: [{ name: 'course', label: 'Course Name', type: 'text' }], gridColSpan: 1 },
        ],
    },

    {
        ...
        fields: [
            ...
            { name: 'keywords', label: 'Related Tools / Technologies', type: 'arrayInput', fields: [{ name: 'keywords', label: 'Keyword', type: 'text' }], gridColSpan: 1 },
        ]
    },
    {
        name: 'projects',
        ...
        fields: [
            ...
            { name: 'highlights', label: 'Key Features', type: 'arrayInput', fields: [{ name: 'highlights', label: 'Feature', type: 'text' }], gridColSpan: 2 },
            { name: 'techStack', label: 'Technologies Used', type: 'arrayInput', fields: [{ name: 'techStack', label: 'Technology', type: 'text' }], gridColSpan: 1 },
            { name: 'startDate', label: 'Start Date', type: 'date', gridColSpan: 1 },
            { name: 'endDate', label: 'End Date', type: 'date', gridColSpan: 1 },
    ...
    },
    {
        ...
        fields: [
            ...
            {
                name: 'highlights', label: 'Key Contributions', type: 'arrayInput', fields: [{
                    name: 'highlights', label: 'Contribution', type: 'text'
                }], gridColSpan: 2,
            },]
    },
    {
